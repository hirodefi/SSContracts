...
contract StarSwapToken is ERC20, Ownable {
     ...
     */
//  constructor() public ERC20("StarSwap Token", "STAR") {
    constructor() ERC20("Test StarSwap Token", "TSTAR") {
        _operator = _msgSender();
        emit OperatorTransferred(address(0), _operator);

        starSwapRouter = IUniswapV2Router02(0x1263Ab6b63905b0833175e0a8Fd640fb3B5c4aC2);
